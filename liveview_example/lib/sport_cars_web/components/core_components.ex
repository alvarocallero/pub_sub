defmodule SportCarsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SportCarsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SportCarsWeb.Gettext, "errors", msg, opts)
    end
  end
